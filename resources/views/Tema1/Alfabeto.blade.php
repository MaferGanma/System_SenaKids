...
<body>
    <div class="container">
        <h2 class="text-gradient">Conozcamos el Abecedario</h2>
        <div class="video-container">
            <iframe src="https://www.youtube.com/embed/b5U1La4EZSs?si=esm8ga3o_Iyvpiv2" 
        ...
        <div class="footer">
            <p>Aprende el abecedario en lenguaje de señas boliviano de manera fácil y divertida.</p>
        </div>
    </div>
</body>
</html>
