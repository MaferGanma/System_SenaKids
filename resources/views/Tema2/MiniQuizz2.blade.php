...
<body>
    <h1><center>¡ADIVINA EL NÚMERO!</center></h1>

    <!-- Pantalla inicial -->
    <div id="pantalla-inicial">
        <p>¿Sabes qué número representa esta seña? Observa bien la imagen y selecciona el número correcto.</p>
        <button class="btn" onclick="comenzarJuego()">COMENZAR A JUGAR</button>
    </div>

    <!-- Pantalla juego -->
    <div class="pantalla-juego" id="pantalla-juego">
        <img src="{{ asset('img/tema2/ad.svg') }}" alt="" id="imgBandera">
        <div class="opciones">
    ...
    <script>
        window.assetUrl = "{{ asset('img/tema2') }}";
    </script>

    <script src="{{ asset('js/scriptQuizz2.js') }}"></script>
</body>
