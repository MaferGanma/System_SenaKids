...
<body>
    <div class="container">
        <h2 class="text-gradient">¡Descubramos los Números Juntos!</h2>
        <div class="video-container">
            <iframe src="https://www.youtube.com/embed/V2Utz8Ce10o?si=BUC4EQFjgvJdO48Q" 
        ...
        <div class="footer">
            <p>¡Domina los números en lenguaje de señas boliviano de forma rápida y fácil!</p>
        </div>
    </div>
</body>
</html>
