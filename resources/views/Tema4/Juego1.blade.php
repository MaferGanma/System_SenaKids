...
<html lang="en">
  ...
  <body>
    ...
    <div class="controls-container">
      <h1><center>¡COLOCA A LOS MIEMBROS DE LA FAMILIA!</center></h1>
      <h4>Arrastra las señas de la familia a su cuadro correcto</h4>
      <p id="result"></p>
    ...
    <!-- Script -->
    <script src="{{ asset('js/scriptDragAndDrop4.js') }}"></script>
  </body>
</html>
