...
<body>
    <div class="container">
        <h2 class="text-gradient">¡Descubre los Días con Señas!</h2>
        <div class="video-container">
            <iframe src="https://www.youtube.com/embed/uffnuQG_Fdk?si=R6Ex7W-Jg0Cx1gLh" 
        ...
        <div class="footer">
            <p>Descubre los días de la semana en lenguaje de señas de manera divertida y fácil.</p>
        </div>
    </div>
</body>
</html>
