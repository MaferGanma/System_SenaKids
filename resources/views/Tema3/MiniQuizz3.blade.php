...
<body>
    <h1><center>¡ATRÉVETE A ADIVINAR EL COLOR!</center></h1>

    <!-- Pantalla inicial -->
    <div id="pantalla-inicial">
        <p>¿Qué color estás viendo en la seña? Mira bien la imagen y elige el color correcto. ¡Vamos, a pintar el mundo con nuestros dedos!</p>
        <button class="btn" onclick="comenzarJuego()">COMENZAR A JUGAR</button>
    </div>

    <!-- Pantalla juego -->
    <div class="pantalla-juego" id="pantalla-juego">
        <img src="{{ asset('img/tema3/ad.svg') }}" alt="" id="imgBandera">
        <div class="opciones">
    ...
    <script>
        window.assetUrl = "{{ asset('img/tema3') }}";
    </script>

    <script src="{{ asset('js/scriptQuizz3.js') }}"></script>
</body>
