...
<head>
    ...
    <title>Texto con Gradiente de Color Animado</title>
    ...
    <style>
        ...
        .text-gradient {
            ...
            background-clip: text; /* Apliamos el degradado al texto */
            ...
            transform: translateX(-50%); /* Alineación exacta en el centro */
...
<body>
    <div class="container">
        <h1 class="text-gradient">¡Colores a todo color!</h1>
        <div class="video-container">
            <iframe src="https://www.youtube.com/embed/_ipwwHnZbwI?si=b67Gkv_m4Bm4UYLR" 
        ...
        <div class="footer">
            <p>¡Descubre los colores del arcoíris y aprende cómo se dicen en lengua de señas!</p>
        </div>
    </div>
</body>
</html>
