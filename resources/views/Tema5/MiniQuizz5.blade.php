...
<body>
    <h1><center>¡ADIVINA EL VERBO!</center></h1>

    <!-- Pantalla inicial -->
    <div id="pantalla-inicial">
        <p>¿Qué acción está representada en esta seña? Mira bien y selecciona el verbo correcto.</p>
        <button class="btn" onclick="comenzarJuego()">COMENZAR A JUGAR</button>
    </div>

    <!-- Pantalla juego -->
    <div class="pantalla-juego" id="pantalla-juego">
        <img src="{{ asset('img/tema5/ad.svg') }}" alt="" id="imgBandera">
        <div class="opciones">
    ...
    <script>
        window.assetUrl = "{{ asset('img/tema5') }}";
    </script>

    <script src="{{ asset('js/scriptQuizz5.js') }}"></script>
</body>
