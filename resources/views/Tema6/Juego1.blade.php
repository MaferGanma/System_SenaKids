...
<html lang="en">
  ...
  <body>
    ...
    <div class="controls-container">
      <h1><center>¡PON LOS ALIMENTOS EN SU LUGAR!</center></h1>
      <h4>Arrastra las señas de los alimentos a su cuadro correcto</h4>
      <p id="result"></p>
    ...
    <!-- Script -->
    <script src="{{ asset('js/scriptDragAndDrop6.js') }}"></script>
  </body>
</html>
