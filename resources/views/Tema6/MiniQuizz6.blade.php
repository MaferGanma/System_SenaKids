...
<body>
    <h1><center>¡ADIVINA QUÉ ALIMENTO ES!</center></h1>

    <!-- Pantalla inicial -->
    <div id="pantalla-inicial">
        <p>¿Qué comida representa esta seña? Observa bien y elige el alimento correcto.</p>
        <button class="btn" onclick="comenzarJuego()">COMENZAR A JUGAR</button>
    </div>

    <!-- Pantalla juego -->
    <div class="pantalla-juego" id="pantalla-juego">
        <img src="{{ asset('img/tema6/ad.svg') }}" alt="" id="imgBandera">
        <div class="opciones">
    ...
    <script>
        window.assetUrl = "{{ asset('img/tema6') }}";
    </script>

    <script src="{{ asset('js/scriptQuizz6.js') }}"></script>
</body>
