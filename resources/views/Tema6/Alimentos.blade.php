...
<body>
    <div class="container">
        <h2 class="text-gradient">Delicias y Sabores: Alimentos en Señas</h2>
        <div class="video-container">
            <iframe src="https://www.youtube.com/embed/DV_FTtp9vDA?si=IGmZzrSgzuXwJi5p" 
        ...
        <div class="footer">
            <p>¿Te gustan las frutas y los jugos? Aprende cómo se dicen estos y otros alimentos en lengua de señas.</p>
        </div>
    </div>
</body>
</html>
