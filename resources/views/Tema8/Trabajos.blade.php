...
<body>
    <div class="container">
        <h2 class="text-gradient">Conozcamos los Oficios: Las Profesiones</h2>
        <div class="video-container">
            <iframe src="https://www.youtube.com/embed/LfjOnqDT-LM?si=y_69DcvDtj-6OK2y" 
        ...
        <div class="footer">
            <p>Desde el médico hasta el bombero, en este video aprenderás los trabajos más importantes en lengua de señas.</p>
        </div>
    </div>
</body>
</html>
